...
# 00 06 * * * cd /home/work/profiling-bin && bash start_daily_inc.sh >> /var/log/pf_start_daily_inc 2>&1

# 跑之前需要前一天的hive tables, 用来计算增量
...
${JAR_DIR}/user-profiling-batch-${VERSION}.jar --date ${date} > ${LOG_DIR}/batch_inc_${date}.log 2>&1 &
