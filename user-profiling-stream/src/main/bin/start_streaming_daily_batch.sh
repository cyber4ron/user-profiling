...
# Deprecated. use start_streaming_daily_dump_to_hdfs.sh instead.

# 00 03 * * * cd /home/work/profiling-bin && bash start_streaming_daily_batch.sh >> /var/log/pf_start_streaming_daily_batch 2>&1
