...
tables = ["dim_merge_agent_area_day",
          "dim_merge_contract_day",
          "dim_merge_cust_need_day",
          "dim_merge_custdel_day",
          "dim_merge_house_day",
          "dim_merge_performance_detail_day",
          "dim_merge_showing_day",
          "dim_merge_showing_house_day"]

hql_tmpl = """hive -e "select count(*) from data_center.{0} where pt='{1}000000'" """
...
if __name__ == "__main__":
    ...
    print metric_dict
    rc = falcon_push.push(metric_dict)
